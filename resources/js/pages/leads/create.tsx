...
// Une icône par type de bien, pour repérer les choix d'un coup d'œil.
const propertyIcons: Record<PropertyType, typeof Bed> = {
    studio: Bed,
    t1: Sofa,
    t2: LayoutPanelLeft,
    t3: LayoutGrid,
    t4: Grid3x3,
    grand_appartement: Building2,
    duplex: Layers,
    loft: Warehouse,
    maison: House,
};
    ...
    return (
        <section aria-labelledby={`section-${step}`} className="grid gap-5">
            <div className="flex items-start gap-3">
                <span
                    aria-hidden
                    className="bg-background text-muted-foreground flex size-7 shrink-0 items-center justify-center rounded-full border text-xs font-medium tabular-nums"
                >
                    {step}
                </span>
                <div>
