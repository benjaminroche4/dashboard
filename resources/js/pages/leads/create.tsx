...
export default function LeadsCreate({
    ...
    // Sens du dernier changement d'étape : le panneau glisse dans ce sens.
        ...
        <>
            ...
            <div className="mx-auto flex w-full max-w-4xl flex-1 flex-col px-4">
                ...
                <form
                    ...
                    data-test="lead-form"
                >
                    {/* Remonté à chaque étape (`key`) : le panneau glisse
                        depuis la droite en avançant, depuis la gauche en
                        revenant — on sait où l'on va. */}
                    <div
                        key={step}
                        className={cn(
                            'contents',
                            direction === 'back'
                                ? 'animate-step-back motion-reduce:animate-none'
                                : 'animate-step-forward motion-reduce:animate-none',
                        )}
                    >
                        {step === 1 && (
                            <>
